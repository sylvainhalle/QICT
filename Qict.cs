...
namespace Gamma
{
  class Qict
  {
	...
	Console.WriteLine("  -i     use invalid combinaison file\n");
    } // ShowUsage() }}}
    ...
    static bool isValid(int[] combinaison)
    {
